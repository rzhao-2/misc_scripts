...
NEW_VERSION_HMM_COLUMN = "hmm_name"
...
with open(HMM_id_list) as file:
    ...
    # HMM_spkg = {
    #     line[NEW_VERSION_HMM_COLUMN]: line[NEW_VERSION_NAME_COLUMN] for line in hmms
    # }
...
for taxfile in taxfiles:
    with open(taxfile) as file:
        ...
        for line in tax:
            ...
            continue
        break # if inner loop breaks, break outer loop
        # taxonomy = [line[1] for line in tax if line[0] == genome_id]
